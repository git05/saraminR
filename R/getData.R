...
saram.func = function(pagecount,keyword){
  ...
  url = url.frame %>% xml2::xml_find_all("//url") %>% xml2::xml_text
  name  = url.frame %>% xml2::xml_find_all("//name") %>% xml2::xml_text
  title = url.frame %>% xml2::xml_find_all("//title") %>% xml2::xml_text
  posting_timestamp = url.frame %>% xml2::xml_find_all("//posting-timestamp") %>% xml2::xml_text
  modification_timestamp = url.frame %>% xml2::xml_find_all("//modification-timestamp") %>% xml2::xml_text
  opening_timestamp = url.frame %>% xml2::xml_find_all("//opening-timestamp") %>% xml2::xml_text
  expiration_timestamp = url.frame %>% xml2::xml_find_all("//expiration-timestamp") %>% xml2::xml_text
  close_type = url.frame %>% xml2::xml_find_all("//expiration-timestamp") %>% xml2::xml_text
  location_code = url.frame %>% xml2::xml_find_all("//location") %>% xml2::xml_attr("code")
  location_name = url.frame %>% xml2::xml_find_all("//location") %>% xml2::xml_text
  job_type_code = url.frame %>% xml2::xml_find_all("//job-type") %>% xml2::xml_attr("code")
  job_type_name = url.frame %>% xml2::xml_find_all("//job-type") %>% xml2::xml_text
  industry_code = url.frame %>% xml2::xml_find_all("//industry") %>% xml2::xml_attr("code")
  industry_name = url.frame %>% xml2::xml_find_all("//industry") %>% xml2::xml_text
  job_category_code = url.frame %>% xml2::xml_find_all("//job-category") %>% xml2::xml_attr("code")
  job_category_name = url.frame %>% xml2::xml_find_all("//job-category") %>% xml2::xml_text
  ...
  experience_level_name = url.frame %>% xml2::xml_find_all("//experience-level") %>% xml2::xml_text
  ...
  read = url.frame %>% xml2::xml_find_all("//read-cnt") %>% xml2::xml_text
  apply = url.frame %>% xml2::xml_find_all("//apply-cnt") %>% xml2::xml_text
  reply = url.frame %>% xml2::xml_find_all("//reply-cnt") %>% xml2::xml_text
  data = data.frame(url,
                    name,
                    title,
                    posting_timestamp,

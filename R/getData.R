...
saram.func = function(pagecount,keyword){
  ...
  data = data.frame(url,
                    name,
                    title,
                    as.POSIXct(as.integer(as.numeric(as.character(posting_timestamp))),origin='1970-01-01'),
                    as.POSIXct(as.integer(as.numeric(as.character(modification_timestamp))),origin='1970-01-01'),
                    as.POSIXct(as.integer(as.numeric(as.character(opening_timestamp))),origin='1970-01-01'),
                    as.POSIXct(as.integer(as.numeric(as.character(expiration_timestamp))),origin='1970-01-01'),
                    close_type,
                    location_code,
                    location_name,
                    job_type_code,
